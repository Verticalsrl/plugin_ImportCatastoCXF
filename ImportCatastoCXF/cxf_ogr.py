...
def write_foglio(foglio, destination, point_borders=False, format_name='ESRI Shapefile'):
    ...
    if foglio['CODICE COMUNE'] in ['G535', 'I258','L380','G476','C261','A484','B266','B868','F618','F625','G226','G793','I307','I410','I451','D292','I143','I089','H683','C722','B305','I785', 'C370']:
    ...
    for oggetto in foglio['oggetti']['BORDO']:
        ...
        feat.SetField('COMUNE', comune_decode) #plugin in QGis necessita di decodifica
        #codice_foglioXX = foglio['CODICE FOGLIO'][5:9] #cosi' dovrebbe essere "0036"
        #feat.SetField('FOGLIO', codice_foglioXX.lstrip('0'))
        feat.SetField('FOGLIO', foglio_intero) #plugin in QGis necessita di decodifica
