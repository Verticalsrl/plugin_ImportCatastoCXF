...
class ImportCatastoCXF:
    ...
    def onClosePlugin(self):
        ...
        #print "** CLOSING ImportCatastoCXF"
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            #print "** STARTING ImportCatastoCXF"
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = ImportCatastoCXFDockWidget()
